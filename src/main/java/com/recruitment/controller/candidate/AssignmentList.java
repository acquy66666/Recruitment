 ...
 * @author hoang
 */
@WebServlet(name = "AssignmentList", urlPatterns = {"/AssignmentList"})
public class AssignmentList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<TestAssignmentDTO> list = dao.getTestWithAssignmentsByCandidateId(candidate.getCandidateId());
        
        for (TestAssignmentDTO testAssignmentDTO : list) {
            count++;
        }
