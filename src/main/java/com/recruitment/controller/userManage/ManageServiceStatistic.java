...
import com.recruitment.dao.ServiceViewDAO.ServiceView;
 ...
 * @author GBCenter
 */
@WebServlet(name = "ManageServiceStatistic", urlPatterns = {"/ManageServiceStatistic"})
public class ManageServiceStatistic extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ManageServiceStatistic</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ManageServiceStatistic at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ServiceView> list = dao.getSortedServiceViews(type, sortBy, sortOrder, top, pageIndex);
            List<String> sList = s.getAllServiceTypes();

            int totalRecords = dao.countAllServiceViews(type);
            ...
            request.getRequestDispatcher("ManageServiceStatistic.jsp").forward(request, response);
