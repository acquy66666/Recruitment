    ...
    <body>
        ...
        <section class="hero-section">
            <div class="container text-center">
                <h1 class="display-4 fw-bold mb-3">Tìm Kiếm Việc Ngay</h1>
                <p class="lead mb-4">Đừng bỏ lỡ vị trí hấp dẫn từ nhà tuyển dụng</p>
            </div>
        </section>
        <form method="get" action="AdvancedJobSearch" id="AdvancedJobSearch">
            <!-- Search Container -->
            <div class="container">
                    ...
                    <div class="col-lg-3">
                        <div class="filter-section">
                            ...
                            <div class="collapse d-lg-block" id="filtersCollapse">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <a href="/Recruitment/AdvancedJobSearch" class="btn btn-outline-primary btn-mg w-100 me-2">
                                            Xóa bộ lọc
                                        </a>
                                    </div>
                                    <div class="col-6">
                        ...
                        <div class="results-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <h6 class="mb-0 me-3">Đã tìm thấy ${filteredCount} kết quả</h6>
                                                ...
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <h5 class="card-title mb-1">
                                                            <a href="CandidateJobDetail?jobID=${item.jobPost.jobId}" class="text-decoration-none">
                                                                ${item.jobPost.title}
                                                            </a>
                                                        </h5>
