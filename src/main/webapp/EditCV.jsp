...
<%
    ...
    int initialSkillIndex = skills.length();
    int initialEduIndex = (education != null ? education.length() : 0);
    int initialExpIndex = experience.length();
%>
    ...
    <body>
        <div class="container-fluid py-4">
            ...
            <div class="main-container p-4">
                <form action="EditCV" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                    <!-- Hidden Fields -->
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address" 
                                           value="<%= personal.getString("address") != null ? personal.getString("address") : "" %>" required>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="birthdate" name="birthdate" placeholder="dd/mm/yyyy" 
                                           value="<%= personal.getString("birthdate") != null ? personal.getString("birthdate") : "" %>" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="email" class="form-label fw-semibold">Email</label>
                                    <input type="email" class="form-control" id="email" name="email" 
                                           value="<%= personal.getString("email") != null ? personal.getString("email") : "" %>" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="phone" class="form-label fw-semibold">Số điện thoại</label>
                                    <input type="text" class="form-control" id="phone" name="phone"
                                           value="<%= personal.getString("phone_number") != null ? personal.getString("phone_number") : "" %>" required
                                ...
                                <div class="input-group-custom">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="edu_major_<%= i %>" 
                                                   value="<%= edu.getString("major") != null ? edu.getString("major") : "" %>" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold">Nơi học</label>
                                            <input type="text" class="form-control" name="edu_place_<%= i %>" 
                                                   value="<%= edu.getString("education_place") != null ? edu.getString("education_place") : "" %>" required>
                                        </div>
                                    </div>
                                </div>
                                <%
                                ...
                                <div class="input-group-custom">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="exp_pos_<%= i %>" 
                                                   value="<%= exp.getString("working_position") != null ? exp.getString("working_position") : "" %>" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold">Nơi làm việc</label>
                                            <input type="text" class="form-control" name="exp_place_<%= i %>" 
                                                   value="<%= exp.getString("working_place") != null ? exp.getString("working_place") : "" %>" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold">Thời gian</label>
                                            <input type="text" class="form-control" name="exp_duration_<%= i %>" 
                                                   value="<%= exp.getString("working_duration") != null ? exp.getString("working_duration") : "" %>" required>
                                        </div>
                                    </div>
                                </div>
                                <%
                                ...
                                <div class="input-group-custom">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" name="skill_<%= i %>" 
                                                   value="<%= skill.getString("skill_name") != null ? skill.getString("skill_name") : "" %>" required>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" 
                                               value="<c:out value='${cv.title != null ? cv.title : ""}'/>" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="cvFile" class="form-label fw-semibold">Tải lên CV</label><c:if test="${not empty cv.cvUrl}">
                                            <a class href="${cv.cvUrl}" target="_blank">Xem File hiện tại</a>
                                        </c:if>
        ...
        <script>
                                ...
                                function addField(sectionId, prefix) {
                                    ...
                                    // Update indices display (if you have a debug section)
                                ...
                                function updateIndicesAfterRemoval(sectionId, prefix) {
                                    ...
                                    // document.getElementById('skillIndexDisplay').innerText = skillIndex;
                                    // document.getElementById('eduIndexDisplay').innerText = eduIndex;
                                    // document.getElementById('expIndexDisplay').innerText = expIndex;
                                }
                                ...
                                document.getElementById("cvFile").addEventListener("change", function () {
                                    ...
                                    let errMsg = document.getElementById("cvFileError");
                                    if (errMsg)
                                        errMsg.remove();
                                    ...
                                    if (file) {
                                        ...
                                        if (!allowedExtensions.exec(file.name)) {
                                            showError("Chỉ cho phép file có định dạng: pdf, png, jpg, jpeg.");
                                            fileInput.value = "";
                                            return;
                                        }
                                        ...
                                        if (file.size > maxSizeMB * 1024 * 1024) {
                                            showError("File quá lớn. Dung lượng tối đa: " + maxSizeMB + "MB.");
                                            fileInput.value = "";
                                            return;
                                        }
                                    }
