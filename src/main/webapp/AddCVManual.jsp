    ...
    <body>
            ...
            <div class="main-container p-4">
                <form action="SaveCVServlet" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group-custom">
                        <div class="row align-items-center">
                            <div class="col">
                                <label class="form-label fw-semibold">Tải lên File CV</label> 
                                <div class="mb-3">
                                    <hr>
                                    <input type="file" class="form-control" id="cvFile" name="cvFile" accept=".pdf,.png,.jpg,.jpeg" required>
        ...
        <script>
                                ...
                                function showError(message) {
                                    const error = document.getElementById("cvFileError") || document.createElement("div");
                                    error.id = "cvFileError";
                                    error.style.color = "red";
                                    error.style.marginTop = "5px";
                                    error.textContent = message;
                                    document.getElementById("cvFile").parentNode.appendChild(error);
                                }
        </script>
    </body>
</html>
