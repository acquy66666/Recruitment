...
<head>
    ...
    <title>Đăng nhập | CVCenter</title>
        ...
        <main>
            <div class="auth-container">
                <div class="auth-header">
                    <h1>Đăng nhập</h1>
                    <p>Chào mừng bạn quay trở lại với CVCenter</p>
                </div>
                ...
                <div class="auth-body">
                    ...
                    <form id="loginForm" method="post" action="login">
                        <input type="hidden" name="accountType" value="candidate"> <%-- Added hidden field --%>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="text" value="${loginId != null ? loginId : ''}" maxlength="50" id="email" name="login" class="form-control" placeholder="Nhập email của bạn" required>
                        </div>
                    ...
                    <div class="auth-footer">
                        <p>Chưa có tài khoản? <a href="registerCandidate">Đăng Ký!</a></p>
                    </div>
                </div>
            </div>
        </main>
