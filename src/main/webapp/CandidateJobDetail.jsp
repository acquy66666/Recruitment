<%-- 
    Document   : CandidateJobDetail
    Created on : May 26, 2025, 2:09:41 PM
    Author     : GBCenter
--%>
    ...
    <head>
        ...
        <style>
            ...
            *, *::before, *::after {
            ...
            .recruiter-job-card:nth-child(1) {
                animation-delay: 0.1s;
            }
            .recruiter-job-card:nth-child(2) {
                animation-delay: 0.2s;
            }
            .recruiter-job-card:nth-child(3) {
                animation-delay: 0.3s;
            }
            .recruiter-job-card:nth-child(4) {
                animation-delay: 0.4s;
            }
            .recruiter-job-card:nth-child(5) {
                animation-delay: 0.5s;
            }
            .recruiter-job-card:nth-child(6) {
                animation-delay: 0.6s;
            }

            /* Toast Notification (add this if not already present) */
            .toast {
                position: fixed;
                bottom: 2rem;
                right: 2rem;
            ...
            <c:choose>
                <c:when test="${mes==''}">
                    <main class="container">
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        ...
                                        <div class="dates">
                                            ...
                                            <div>Hết hạn: <fmt:parseDate value="${data.getDeadline()}" pattern="yyyy-MM-dd" var="deadlineDate" />
                                                <fmt:formatDate value="${deadlineDate}" pattern="dd/MM/yyyy" /></div>
                                        </div>
                                        <div>
                                            <c:choose>
                                                <c:when test="${status=='no'}">
                                                    <a href="JobApplication?jobID=${data.jobId}" class="btn btn-primary">Ứng tuyển ngay</a>                                           
                                                </c:when>
                                                <c:when test="${status=='ok'}">
                                                    <div>Bạn cần đăng nhập để ứng tuyển</div>
                                                    <a href="login" class="btn btn-primary">Đăng nhập ngay</a>
                                                </c:when>
                                                <c:otherwise>                                 
                                                     
                                                   <c:choose>
                                                        <c:when test="${status=='Pending' || status=='Interview' || status=='Accepted' || status=='Testing'}"><a class="btn btn-primary">Bạn đã ứng tuyển cho công việc này rồi</a></c:when>
                                            ...
                                            <c:choose>
                                                        ...
                                                        <div class="recruiter-job-card">
                                                            <div class="job-card-header">
                                                                <h3 class="job-card-title">
                                                                    <a href="CandidateJobDetail?jobID=${job.jobId}">${job.title}</a>
                                                                </h3>
                                                            ...
                                                            <div class="job-card-footer">
                                                                ...
                                                                <a href="CandidateJobDetail?jobID=${job.jobId}" class="btn btn-primary btn-sm">
                                                                    Xem chi tiết
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <c:otherwise>
                                                    <div class="no-jobs-message">
                                                        ...
                                                        <h3>Chưa có việc làm khác</h3>
                                                        <p>Công ty này hiện tại chưa có việc làm khác đang tuyển dụng.</p>
                                                    </div>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                        ...
                        <section class="recruiter-jobs-section">
                            <div class="container">
                                <div class="card">
                                    <div class="card-content">
                                        <div class="section-header">
                                            <div class="section-title-wrapper">
                                                <div class="company-logo-small">
                                                    ...
                                                    <rect x="0" y="0" width="48" height="48" rx="8" ry="8" fill="#eee" stroke="#ccc" stroke-width="1"/>
                                                    <image href="${recruiter.getCompanyLogoUrl()}" x="0" y="0" width="48" height="48" preserveAspectRatio="xMidYMid slice"/>
                                                    </svg>
                                                </div>
                                                <div>
                                                    <h2 class="section-title">Việc làm khác từ ${recruiter.getCompanyName()}</h2>
                                                    <p class="section-subtitle">Khám phá thêm cơ hội nghề nghiệp tại công ty này</p>
                                                </div>
                                            </div>

                                            <!-- Jobs Grid -->
                                            <div class="recruiter-jobs-grid">
                                                <c:choose>
                                                    <c:when test="${not empty recruiterJobs}">
                                                        <c:forEach items="${recruiterJobs}" var="job" varStatus="status">
                                                            <c:if test="${job.jobId != data.jobId && status.index <= 6}">
                                                                <div class="recruiter-job-card">
                                                                    <div class="job-card-header">
                                                                        <h3 class="job-card-title">
                                                                            <a href="CandidateJobDetail?jobID=${job.jobId}">${job.title}</a>
                                                                        ...
                                                                        <div class="job-card-meta">
                                                                            ...
                                                                            <span class="job-posted-date">
                                                                                <fmt:parseDate value="${job.createdAt}" pattern="yyyy-MM-dd" var="jobCreatedDate" />
                                                                                <fmt:formatDate value="${jobCreatedDate}" pattern="dd/MM" />
                                                                            </span>
                                                                        </div>
                                                                    </div>
