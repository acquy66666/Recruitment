...
<html>
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <!-- Lọc nâng cao -->
            <div class="col-md-2">
                <a href="RevenueExel2" class="btn btn-outline-secondary w-100">
                    Lọc theo ngày
                </a>
            </div>
            <div class="report-card">
                <div class="card-header-custom">
                    ...
                    <form action="ExportRevenueExel" method="post" class="d-inline">
                        <input type="hidden" name="searchMonth" value="${searchMonth}">
                        <input type="hidden" name="minRevenue" value="${minRevenue}">
                        <input type="hidden" name="maxRevenue" value="${maxRevenue}">
                        <input type="hidden" name="promotionRevenue" value="${promotionRevenue}">
                        <input type="hidden" name="sortByRevenue" value="${sortByRevenue}">
                ...
                <div class="filter-section">
                    <form id="RevenueExel" method="post" action="RevenueExel">
                        <input type="hidden" name="displayPercentRevenue" value="${displayPercentRevenue}">
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" id="minRevenue" name="minRevenue" class="form-control" placeholder="100,000 ..." value="${minRevenue}">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Doanh thu đến</label>
                                <input type="text" id="maxRevenue" name="maxRevenue" class="form-control" placeholder="1,000,000 ..." value="${maxRevenue}">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Khuyến mãi</label>
                                <select name="promotionRevenue" class="form-select">
                                    <option value="all" ${promotionRevenue == 'all' ? 'selected' : ''}>Tất cả khuyến mãi</option>
                                    <option value="yes" ${promotionRevenue == 'yes' ? 'selected' : ''}>Có khuyến mãi</option>
                                    <option value="no" ${promotionRevenue == 'no' ? 'selected' : ''}>Không có khuyến mãi</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Lọc theo</label>
                                <select name="sortByRevenue" class="form-select">
                                    <option value="month_asc" ${sortByRevenue == 'month_asc' ? 'selected' : ''}>Tháng tăng dần</option>
                                    <option value="month_desc" ${sortByRevenue == 'month_desc' ? 'selected' : ''}>Tháng giảm dần</option>
                                    <option value="revenue_asc" ${sortByRevenue == 'revenue_asc' ? 'selected' : ''}>Doanh thu tăng dần</option>
                                    <option value="revenue_desc" ${sortByRevenue == 'revenue_desc' ? 'selected' : ''}>Doanh thu giảm dần</option>
                                    <option value="service_asc" ${sortByRevenue == 'service_asc' ? 'selected' : ''}>Gói dịch vụ tăng dần</option>
                                    <option value="service_desc" ${sortByRevenue == 'service_desc' ? 'selected' : ''}>Gói dịch vụ giảm dần</option>
                                </select>
                            </div>
                            <div class="col-md-1">
                ...
                <c:if test="${not empty errorMessageRevenue}">
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ${errorMessageRevenue}
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <c:remove var="errorMessageRevenue" scope="session" />
                </c:if>
                <script>
                    setTimeout(function () {
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        ...
                                        <tr style="background-color: #f8f9fa; font-weight: bold;">
                                            ...
                                            <td>${totalRecruiter}</td>
                                            <td>${totalService}</td>
                                            <td class="amount-text">${totalBeforeDiscount} đ</td>
                                            <td style="color: #dc3545;">${totalDiscount} đ</td>
                                            <td class="amount-text">${totalNetRevenue} đ</td>
                                        </tr>
                                    </c:otherwise>
                                </c:choose>
                            </tbody>
